...
export * from "./components/facilmap/facil-map.vue";
export { default as FacilMap } from "./components/facilmap/facil-map.vue";
...
export { default as ManageBookmarksDialog } from "./components/manage-bookmarks/manage-bookmarks-dialog.vue";
