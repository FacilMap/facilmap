...
* Typing a route query in the form `<place> to <place>` will open the route form, see [Calculate a route](../route/#using-a-route-query).
...
<video controls style="height: 340px">
	<source src="./details.mp4">
</video>
<video controls style="height: 340px">
	<source src="./details-mobile.mp4">
</video>
